	...
	;(e = (function() {
		...
		return (e.prototype.hasNext = function() {
			...
			return this.options.before != null &&
				...
				this.options.before.call(this), typeof document != "undefined" &&
				document !== null &&
				(
			...
			if (
				...
				;(m = e.data), (A = parseInt(this.options.limit, 10)), this.options
					.limit != null &&
					m.length > A &&
					(m = m.slice(0, A)), (u = document.createDocumentFragment()), this
					.options.filter != null &&
				...
				if (
					...
					for (c = 0, N = m.length; c < N; c++) {
						...
						;(E = p.width), (y = p.height), (b = "square"), E > y &&
							(b = "landscape"), E < y && (b = "portrait"), (v = p.url), (l =
							window.location.protocol.indexOf("http") >= 0), l &&
							!this.options.useHttp &&
							(v = v.replace(/https?:\/\//, "//")), (d = this._makeTemplate(
					...
					for (T = 0, k = m.length; T < k; T++) {
						...
						;(v = p.url), (l =
							window.location.protocol.indexOf("http") >= 0), l &&
							!this.options.useHttp &&
							(v = v.replace(/https?:\/\//, "//")), (g.src = v), this.options
							.links === !0
							? (
				...
				_.appendChild(u), (a = document.getElementsByTagName(
					"head"
				)[0]), a.removeChild(document.getElementById("instafeed-fetcher")), (S =
			...
			return (n = e + "/" + t), this.options.accessToken != null
				...
				: (n += "?client_id=" + this.options.clientId), this.options.limit !=
				null && (n += "&count=" + this.options.limit), (n +=
